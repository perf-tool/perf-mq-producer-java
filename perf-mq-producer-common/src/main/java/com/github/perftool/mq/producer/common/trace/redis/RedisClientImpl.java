...
package com.github.perftool.mq.producer.common.trace.redis;
...
import com.github.perftool.mq.producer.common.trace.redis.functional.SyncCommandCallback;
...
public class RedisClientImpl implements TraceReporter {
    ...
    public void reportTrace(TraceBean traceBean) {
        try {
            ...
            set("traceid:" + traceBean.getTraceId(), mapper.writeValueAsString(traceBean));
        } catch (Exception e) {
